...
namespace MH.WaterCausticsModules {
    ...
    public class WCMReadmeEditor : Editor {
        ...
        private readonly bool URP_EXIST = false;
#else
        private readonly bool URP_EXIST = true;
#endif

#if WCE_URP_17_0 //|| WCE_DEVELOPMENT
        private readonly bool URP_17 = true;
#else
        private readonly bool URP_17 = false;
#endif
        ...
        public override void OnInspectorGUI () {
            ...
            if (URP_17) {
                GUILayout.Space (2);
                labelWarning ($"This asset is not compatible with current URP version 17.0 or higher. URP {Constant.REQUIRE_URP_VER} is required.");
                GUILayout.Space (6);
            }
